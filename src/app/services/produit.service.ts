...
export class ProduitService {
  ...
  apiURLR: string = 'http://localhost:8087/users/register';
  apiURLRole: string = '  http://localhost:8087/users/role';
  ...
  ajouterRole( cat: User):Observable<User>{
    return this.http.post<User>(this.apiURLRole, cat, httpOptions);
    }

  ajouterUser( cat: User):Observable<User>{
    return this.http.post<User>(this.apiURLR, cat, httpOptions);
    }
